...
namespace agave::details
{
    ...
    public:
        ...
        timespan_awaiter_t(
            Promise *promise,
            std::chrono::high_resolution_clock::duration dur) noexcept : _promise{promise}, _dur{dur},
        ...
        //--------------------------------------------------------------------
        timespan_awaiter_t(timespan_awaiter_t const &other) noexcept : _promise{other._promise}, _dur{other._dur}, _h{other._h},
        ...
        //--------------------------------------------------------------------
        timespan_awaiter_t(timespan_awaiter_t &&other) noexcept : _promise{other._promise}, _dur{other._dur}, _h{other._h},
                                                                  _async_data{other._async_data},
                                                                  _is_awake{other._is_awake.load(std::memory_order::consume)}
        {
            return;
    ...
    public:
        ...
        suspend_always_t(
            ...
            std::function<T(void)> resume_cb) noexcept : _ready_cb{ready_cb}, _resume_cb{resume_cb}
        {
            //
        }
    ...
    protected:
        //--------------------------------------------------------------------
        progress_reporter_base_t(std::shared_ptr<progress_data_t<Progress>> pg_data) : _pg_data{pg_data}
        {
            //
        }
    ...
    public:
        //--------------------------------------------------------------------
        progress_controller_t(std::shared_ptr<progress_data_t<Progress>> pt_data) noexcept : _pg_data(pt_data) {
                                                                                                 //
                                                                                             };
    ...
    public:
        //--------------------------------------------------------------------
        caller_raw_coroutine_handle_awaiter_t(std::coroutine_handle<> handle) noexcept : _handle{handle}
        {
            //
        }
    ...
    public:
        //--------------------------------------------------------------------
        raw_coroutine_handle_awaiter_t(std::coroutine_handle<> handle) noexcept : _handle{handle}
        {
            //
        }
    ...
    public:
        //--------------------------------------------------------------------
        progress_controller_awaiter_t(std::shared_ptr<progress_data_t<Progress>> pg_data) noexcept : _pg_data{pg_data}
        {
            //
        }
    ...
    class async_operation_t : public async_operation_base_t<T, Progress, async_operation_t<T, Progress>>
    {
    public:
        //--------------------------------------------------------------------
    ...
    public:
        ...
        auto await_transform(Awaitable &&value) noexcept
        {
            // 直接原样返回，让编译器走 Awaiter 的 operator co_await
    ...
    //--------------------------------------------------------------------
    template <typename Progress>
    class async_action_promise_t : public promise_base_t<void, async_action_promise_t<Progress>, Progress>
    {
    public:
        //--------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------
    template <typename T, typename Progress>
    class async_operation_promise_t : public promise_base_t<T, async_operation_promise_t<T, Progress>, Progress>
    {
    public:
        //--------------------------------------------------------------------
...
//--------------------------------------------------------------------
template <typename P>
inline agave::details::async_action_t<P>
...
//--------------------------------------------------------------------
template <typename T, typename P>
inline agave::details::async_operation_t<T, P>
...
//--------------------------------------------------------------------
template <typename P>
inline agave::details::progress_reporter_t<P>
